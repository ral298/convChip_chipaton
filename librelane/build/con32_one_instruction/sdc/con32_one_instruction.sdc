...
set_input_delay 10.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {rxd}]
set_output_delay 10.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {rx_sample_pulse}]
set_output_delay 10.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {rxd_out}]
set_output_delay 10.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {tx_busy}]
set_output_delay 10.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {txd}]
###############################################################################
# Environment
###############################################################################
