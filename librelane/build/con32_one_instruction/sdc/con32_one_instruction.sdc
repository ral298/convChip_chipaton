...
# Timing Constraints
###############################################################################
create_clock -name clk_ref -period 20.0000 [get_ports {clk_ref}]
...
set_input_delay 4.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {rst}]
set_input_delay 4.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {rxd}]
set_output_delay 4.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {rx_sample_pulse}]
set_output_delay 4.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {rxd_out}]
set_output_delay 4.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {tx_busy}]
set_output_delay 4.0000 -clock [get_clocks {clk_ref}] -add_delay [get_ports {txd}]
###############################################################################
# Environment
###############################################################################
